...
namespace BlogApp.Web.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,CommentedDate,PostId,AuthorId")] Comment comment)
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.Author, "Id", "Id", comment.AuthorId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,CommentedDate,PostId,AuthorId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
